...
import { DatePickerWithYearNavigation } from "./DatePickerWithYearNavigation";
import {
  Form,
  FormControl,
  FormDescription,
...
import { getSafeFieldProps } from "@/lib/form-utils";
import { queryFnObjectById } from "@/lib/queryClient";
...
export default function ClientDetail({ clientId }: ClientDetailProps) {
  ...
  const { data: client = {}, isLoading } = useQuery({
    ...
    queryFn: queryFnObjectById('/api/clients'),
  });
  
  const { data: projects = [] } = useQuery({
    queryKey: ['/api/clients', clientId, 'projects'],
    queryFn: () => apiRequest('GET', `/api/clients/${clientId}/projects`).then(res => res.json()),
  });
  
  const { data: interactions = [] } = useQuery({
    queryKey: ['/api/clients', clientId, 'interactions'],
    queryFn: () => apiRequest('GET', `/api/clients/${clientId}/interactions`).then(res => res.json()),
  });
  
  const { data: financialDocuments = [] } = useQuery({
    queryKey: ['/api/clients', clientId, 'financial-documents'],
    queryFn: () => apiRequest('GET', `/api/clients/${clientId}/financial-documents`).then(res => res.json()),
  });
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Cliente desde {client.since ? format(new Date(client.since), 'MMMM yyyy', { locale: ptBR }) : 'N/A'}
              </p>
            </div>
          </div>
        </div>
                  ...
                  {client.contactName && (
                    <div className="grid grid-cols-[20px_1fr] gap-2 items-start">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground">{client.contactPosition || 'Sem cargo definido'}</p>
                      </div>
                    </div>
                  )}
                  ...
                  {client.address && (
                    <div className="grid grid-cols-[20px_1fr] gap-2 items-start">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground">{client.city || 'Sem cidade definida'}</p>
                      </div>
                    </div>
                  )}
                </div>
                  ...
                  <div className="grid grid-cols-[20px_1fr] gap-2 items-start">
                    ...
                    <div>
                      <p className="text-sm font-medium capitalize">
                        {client.type === 'enterprise' ? 'Empresa' :
                         client.type === 'startup' ? 'Startup' :
                         client.type === 'government' ? 'Governo' :
                         client.type === 'agency' ? 'Agência' : 'Outro'}
                      </p>
                    ...
                    <div className="grid grid-cols-[20px_1fr] gap-2 items-start">
                      ...
                      <div>
                        <p className="text-sm font-medium">
                          {format(new Date(client.since), 'dd MMM yyyy', { locale: ptBR })}
                        </p>
                  ...
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <Badge variant={
                      ...
                      {project.status === 'active' ? 'Ativo' : 
                       ...
                       project.status === 'completed' ? 'Concluído' : 'N/A'}
                    </Badge>
                  </div>
                  <p className="text-sm text-muted-foreground ml-4">{project.description}</p>
                  <div className="flex justify-between items-center mt-2 ml-4">
                    <div className="text-xs text-muted-foreground">
                      {project.start_date && `Início: ${formatDate(project.start_date)}`}
                      {project.end_date && ` • Término: ${formatDate(project.end_date)}`}
                    </div>
                          ...
                          <div className="flex-1">
                            <div className="flex justify-between">
                              <div>
                                ...
                                <Badge variant={interaction.type === 'reuniao' ? 'success' : interaction.type === 'feedback' ? 'warning' : 'success'} className="ml-2 capitalize">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Abreviação ou sigla" {...getSafeFieldProps(field)} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="00.000.000/0000-00" {...getSafeFieldProps(field)} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Nome do contato" {...getSafeFieldProps(field)} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Ex: Gerente de Marketing" {...getSafeFieldProps(field)} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="email@exemplo.com" {...getSafeFieldProps(field)} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="(00) 00000-0000" {...getSafeFieldProps(field)} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Endereço completo" {...getSafeFieldProps(field)} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Cidade" {...getSafeFieldProps(field)} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="exemplo.com" {...getSafeFieldProps(field)} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
      ...
      <Dialog open={isNewProjectDialogOpen} onOpenChange={setIsNewProjectDialogOpen}>
        <DialogContent className="sm:max-w-[600px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Adicione um novo projeto para {client.name}
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="p-6">
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5 mt-4">
                ...
                <div className="flex justify-end gap-2 sticky bottom-0 pt-4 pb-2 bg-background mt-8">
      ...
      <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Esta ação não pode ser desfeita. Isso excluirá permanentemente o cliente <strong>{client.name}</strong> e todos os seus dados.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
  ...
  const form = useForm<InsertClient>({
    ...
    defaultValues: {
      name: client.name || '',
      shortName: client.shortName || null,
      type: client.type || 'enterprise',
      cnpj: client.cnpj || null,
      contactName: client.contactName || null,
      contactPosition: client.contactPosition || null,
